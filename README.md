...
| easy4j dependencies | `shiro-biz`, `jwt-issuer-api` (both `3.0.x.x.20260630-SNAPSHOT`) |
...
```groovy
implementation 'io.github.easy4j:shiro-jwt-extension:3.0.x.x.20260630-SNAPSHOT'
```
