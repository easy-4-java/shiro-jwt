...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/shiro-jwt) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)
...
| easy4j dependencies | `shiro-extension-spring`, `jwt-issuer-api` (both `3.0.x.20260630-SNAPSHOT`) |
...
The artifact is not yet published to Maven Central. Resolve it from the project's configured artifact repository (Aliyun Packages) or install it locally from source; the snapshot version currently used on the `feature/3.0.x` branch is `3.0.x.20260630-SNAPSHOT`.
...
```groovy
implementation 'io.github.easy4j:shiro-jwt-spring:3.0.x.20260630-SNAPSHOT'
```
